...
export default function About() {
  return (
    <div className='bg-stone-100 text-center shadow-md h-full'>
      ...
      <h1 className='text-3xl font-bold mb-1 text-stone-800'>About NayaNivas</h1>
      <p className='mb-4 text-stone-500'>Welcome to NayaNivas, your ultimate destination for all your property needs. Whether you're looking to buy, sell, or rent a property, our platform provides a seamless and efficient experience for both buyers and sellers.
<br/>
...
<br/>
<h1 className='text-3xl font-bold mb-1 text-stone-800'>What We Offer:</h1>
<ul className='mb-1 text-stone-500'>
        <li><strong className=' text-stone-600'>Extensive Listings:</strong> Explore a wide range of properties available for sale and rent, catering to various tastes and budgets. From cozy apartments to luxurious homes, we have it all.</li>
      ...
      <br/>
      <h1 className='text-3xl font-bold mb-1 text-stone-800'>Why Choose Us?</h1>
      <ul className='mb-1 text-stone-500'>
        <li><strong className=' text-stone-600'>Expertise and Experience:</strong> With years of experience in the real estate industry, we bring you a wealth of knowledge and expertise to help you make informed decisions.</li>
      ...
      <h1 className='text-3xl font-bold mb-1 text-stone-800'>About Developer</h1><br/>
      ...
      <p className="text-center text-stone-700 italic mt-2">"Combining tech innovation and real estate savvy to revolutionize your property journey."</p>
